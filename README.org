...
4. Note: The =:WILD_NOTIFIER_NOTIFY_BEFORE:= / =:CHIME_NOTIFY_BEFORE:= property has been removed. Use the global =chime-alert-time= variable instead (e.g., =(setq chime-alert-time '(30 15 5 0))=).
